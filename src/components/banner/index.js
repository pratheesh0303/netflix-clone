...
import {BannerContainer, Topbar, Logo, LanguageDropdown, SigninBtn, TextConatiner, Title, SubTitle} from './styles/banner';
export default function Banner({children, ...restProps}){
    return (
        <BannerContainer {...restProps}>{children}</BannerContainer>
    )
}
...
Banner.LanguageDropdown = function BannerLanguageDropdown({ children, ...restProps }) {
...
Banner.TextConatiner = function BannerTextConatiner({ children, ...restProps }) {
